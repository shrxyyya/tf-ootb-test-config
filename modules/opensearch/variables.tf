...
variable "private_subnet_ids" {
  description = "Private subnet IDs. At least 3 required for multi-AZ OpenSearch deployment."
  type        = list(string)
}

variable "kms_key_arn" {
  description = "ARN of the KMS key used for OpenSearch encryption at rest."
  type        = string
}

variable "private_subnet_cidrs" {
  description = "CIDR blocks of the private subnets; used to scope the OpenSearch security group ingress."
  type        = list(string)
  default     = []
}
