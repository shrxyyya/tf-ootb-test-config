...
variable "private_subnet_ids" {
  description = "Private subnet IDs for SageMaker notebook and model VPC config."
  type        = list(string)
}

variable "kms_key_arn" {
  description = "ARN of the KMS key used for SageMaker notebook and endpoint encryption."
  type        = string
}
