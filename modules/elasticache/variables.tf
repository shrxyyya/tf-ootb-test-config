...
variable "kms_key_arn" {
  description = "ARN of the KMS key used for ElastiCache at-rest encryption."
  type        = string
}

variable "private_subnet_cidrs" {
  description = "CIDR blocks of the private subnets; used to scope the ElastiCache security group ingress."
  type        = list(string)
  default     = []
}
